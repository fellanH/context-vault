...
const REQUIRED_VARS = ['CWS_CLIENT_ID', 'CWS_CLIENT_SECRET', 'CWS_REFRESH_TOKEN', 'CWS_EXTENSION_ID'];
...
if (uploadData.uploadState === 'FAILURE') {
  console.error('Upload failed:', JSON.stringify(uploadData.itemError, null, 2));
  process.exit(1);
}
