...
export function Register() {
  ...
  const connectCmd = generatedKey ? `npx context-vault connect --key ${generatedKey}` : "";
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" size="icon" onClick={copyCommand}>
                    {copiedCmd ? <Check className="size-4" /> : <Copy className="size-4" />}
                  </Button>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground">Or manual config</span>
                </div>
              </div>
