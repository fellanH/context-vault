...
function SearchBar({ onSearch, loading }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, style: { padding: "12px 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
...
function ResultList({ results, query, onInject }) {
  if (!query) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "24px 16px", textAlign: "center", color: "#64748b", fontSize: "13px" }, children: "Search your vault to find relevant context." });
  }
  if (results.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px 16px", textAlign: "center", color: "#64748b", fontSize: "13px" }, children: [
      'No results for "',
      query,
      '"'
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "0 16px 16px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "12px", color: "#64748b", marginBottom: "8px" }, children: [
      results.length,
      " result",
      results.length !== 1 ? "s" : ""
    ] }),
    results.map((result) => /* @__PURE__ */ jsxRuntimeExports.jsx(ResultCard, { result, onInject }, result.id))
  ] });
}
function ResultCard({ result, onInject }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "4px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "14px", fontWeight: 500, color: "#f1f5f9", flex: 1 }, children: title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "12px", color: "#94a3b8", marginBottom: "4px" }, children: [
      result.score.toFixed(3),
      " · ",
      result.tags.join(", ") || "no tags"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontSize: "13px", color: "#cbd5e1", lineHeight: "1.4", marginBottom: "8px" }, children: [
      preview,
      preview.length >= 150 ? "..." : ""
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Settings({ onSaved }) {
  const [serverUrl, setServerUrl] = reactExports.useState(DEFAULT_SETTINGS.serverUrl);
  ...
  function handleTest() {
    setTesting(true);
    setTestResult(null);
    chrome.runtime.sendMessage({ type: "save_settings", serverUrl, apiKey }, (saveResponse) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { fontSize: "14px", fontWeight: 600, marginBottom: "16px" }, children: "Settings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", fontSize: "12px", color: "#94a3b8", marginBottom: "4px" }, children: "Server URL" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "url",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { style: { display: "block", fontSize: "12px", color: "#94a3b8", marginBottom: "4px" }, children: "API Key" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "password",
    ...
    testResult && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
      padding: "8px 12px",
      marginBottom: "12px",
      borderRadius: "6px",
      fontSize: "13px",
    ...
    }, children: testResult.success ? "Connected successfully" : `Connection failed: ${testResult.error}` }),
...
function App() {
  ...
  const [rateLimitRemaining, setRateLimitRemaining] = reactExports.useState(null);
  reactExports.useEffect(() => {
    chrome.runtime.sendMessage({ type: "get_settings" }, (response) => {
      if (response?.type === "settings") {
  ...
  function handleSearch(q) {
    ...
    setLoading(true);
    setError(null);
    chrome.runtime.sendMessage({ type: "search", query: q, limit: 10 }, (response) => {
      setLoading(false);
  ...
  const showRateLimitWarning = connected && rateLimitRemaining !== null && Number.isFinite(rateLimitRemaining) && rateLimitRemaining < 10;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "16px", fontWeight: 600 }, children: "Context Vault" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
          width: "8px",
          height: "8px",
          borderRadius: "50%",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: view === "settings" ? "Back" : "Settings"
        }
      )
    ] }),
    showRateLimitWarning && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, overflow: "auto" }, children: view === "settings" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      Settings,
      {
    ...
    ) : !connected ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          border: "1px solid #334155",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "14px", fontWeight: 600, marginBottom: "8px" }, children: "Connect Your Vault" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "13px", color: "#94a3b8", marginBottom: "12px", lineHeight: "1.4" }, children: "Add your server URL and API key in Settings before searching or injecting context." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(SearchBar, { onSearch: handleSearch, loading }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 16px", color: "#ef4444", fontSize: "13px" }, children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResultList, { results, query, onInject: handleInject })
    ] }) })
  ] });
}
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "24px", textAlign: "center" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "24px", marginBottom: "12px" }, children: "Something went wrong" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "13px", color: "#94a3b8", marginBottom: "16px" }, children: this.state.error }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
